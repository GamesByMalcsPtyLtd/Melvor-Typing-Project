...
declare function fetchLanguageJSON(lang: 'catOrder'): Promise<[LanguageCategory, string][]>;
...
declare function getLangString(key: LanguageCategory, identifier: string | number): string;
